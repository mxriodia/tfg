"""
Django settings for gestion_aulas project.
...
SECRET_KEY = "django-insecure-@cp#94*02b*n^t$=ppi6_u5ojwxo=6ay0l0$y(ei=+qz^$uj8s"
...
ROOT_URLCONF = "gestion_aulas.urls"
...
WSGI_APPLICATION = "gestion_aulas.wsgi.application"
